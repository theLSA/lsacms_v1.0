...
<header class="am-topbar admin-header">
 ...
 <li class="kuanjie">
 	...
 	<a href="/lsacms/admin.php/Main/stuhome">HOME</a> 
 	<a href="/lsacms/admin.php/Main/index">个人主页</a> 
 	 <a href="/lsacms/admin.php/Main/stulogout">退出登录</a>
 </li>
...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <ul>
        <li><a href="/lsacms/admin.php/Main/getselfinfo">个人信息</a></li>
        <li class="func" dataType='html' dataLink='msn.htm' iconImg='images/msn.gif'><a href="/lsacms/admin.php/Main/getselflesson?stuid=<?php echo (session('student')); ?>">个人课程</a></li>
        <li><a href="/lsacms/admin.php/Main/chooseles?stuid=<?php echo (session('student')); ?>">选课</a></li>
...
<div class=" admin-content">
	...
	<div class="daohang">
              ...
              <font color="white">个人主页->个人课程</font>
...
<table width="600" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr>
    <td colspan="5" bgcolor="#FFFFFF" class="title" align="center">个人课程</td>
  </tr>
  <tr class="title">
    <td bgcolor="#FFFFFF" width="100">课程ID</td>
    <td bgcolor="#FFFFFF" width="200">课程</td>
    <td bgcolor="#FFFFFF" width="50">分数</td>
