...
<table width="1500" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr class="title">
    ...
    <td bgcolor="#FFFFFF" width="100">开设课程名</td>
    <td bgcolor="#FFFFFF" width="200">课程归属</td>
    <td bgcolor="#FFFFFF" width="150">该课学生人数</td>
    <td bgcolor="#FFFFFF" width="200">课程ID</td>
   
  </tr>
  <?php if(is_array($tealesinfo)): foreach($tealesinfo as $key=>$teales): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100"><?php echo ($teales["teaid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($teales["teaname"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($teales["teales"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($teales["lesfaction"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($teales["tealesstunum"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($teales["lesid"]); ?></td>
