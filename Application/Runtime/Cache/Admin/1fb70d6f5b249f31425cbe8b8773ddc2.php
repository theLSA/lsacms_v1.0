...
<form method="post" action="/lsacms/admin.php/Main/addstu">
<h3>---------------------------学生帐号信息----------------------------</h3>
stuid:<input name="stuid" type="text"><br/>
stuname:<input name="stuname" type="text"><br/>
stupwd:<input name="stupwd" type="password"><br/>
stupwd again:<input name="stupwd_again" type="password"><br/>
<h3>-------------------------学生个人信息-------------------------------</h3>
stusex:<input name="stusex" type="text"><br/>
stuage:<input name="stuage" type="text"><br/>
stufaction:<input name="stufaction" type="text"><br/>
<input name="stulesnum" type="hidden" value="0"><br/>
