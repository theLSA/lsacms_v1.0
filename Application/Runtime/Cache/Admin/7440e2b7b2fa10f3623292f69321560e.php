...
<form method="post" action="/lsacms/admin.php/Main/changeapwd">
<input name="aname" value="<?php echo (session('admin')); ?>" type="hidden">
原密码：<input name="old_apwd" type="password"><br/>
新密码：<input id="pwd1" name="new_apwd" type="password"><br/>
再次确认新密码：<input id="pwd2" name="new_apwd_again" type="password"><br/>
<input type="submit" value="修改" onclick="return checkpasswd()">
</form>
