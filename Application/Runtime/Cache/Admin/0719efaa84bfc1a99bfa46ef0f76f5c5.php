...
<table width="1500" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr class="title">
    ...
    <td bgcolor="#FFFFFF" width="100">教师密码</td>

  </tr>
  <?php if(is_array($teauserinfo)): foreach($teauserinfo as $key=>$tea): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100"><?php echo ($tea["teaid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($tea["teaname"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($tea["teapwd"]); ?></td>
