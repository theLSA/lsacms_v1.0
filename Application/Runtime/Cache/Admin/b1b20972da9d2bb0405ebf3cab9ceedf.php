...
<form method="post" action="/lsacms/admin.php/Main/addtea">
<h3>---------------------------教师帐号信息----------------------------</h3>
teaid:<input name="teaid" type="text"><br/>
teaname:<input name="teaname" type="text"><br/>
teapwd:<input name="teapwd" type="password"><br/>
teapwd again:<input name="teapwd_again" type="password"><br/>
<h3>-------------------------教师个人信息-------------------------------</h3>
teasex:<input name="teasex" type="text"><br/>
teaage:<input name="teaage" type="text"><br/>
teafaction:<input name="teafaction" type="text"><br/>
<input name="tealesnum" type="hidden" value="0"><br/>
