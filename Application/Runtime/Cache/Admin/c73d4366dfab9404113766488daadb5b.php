...
<table width="1500" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  <tr>
  ...
  <tr class="title">
    ...
    <td bgcolor="#FFFFFF" width="100">课程名</td>
    <td bgcolor="#FFFFFF" width="100">分数</td>
    <td bgcolor="#FFFFFF" width="150">课程教师</td>
    <td bgcolor="#FFFFFF" width="200">课程归属</td>
    <td bgcolor="#FFFFFF" width="200">课程ID</td>

  </tr>
  <?php if(is_array($stulesinfo)): foreach($stulesinfo as $key=>$stules): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stules["stuid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($stules["stuname"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stules["stules"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stules["stuscore"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($stules["stulestea"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($stules["stulesfaction"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($stules["lesid"]); ?></td>
