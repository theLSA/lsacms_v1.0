...
<div class=" admin-content">
	...
	<div class="daohang">
              ...
              <font color="white">个人主页->学生信息管理->学生信息修改</font>
...
<form method="post" action="/lsacms/admin.php/Main/udteainfo">

<input name="teaid" type="hidden" value="<?php echo ($data["teaid"]); ?>"/>
教师姓名：<input name="teaname" type="text" value="<?php echo ($data["teaname"]); ?>"/>
教师性别：<input name="teasex" type="text" value="<?php echo ($data["teasex"]); ?>"/>
教师年龄：<input name="teaage" type="text" value="<?php echo ($data["teaage"]); ?>"/>
教师帮派：<input name="teafaction" type="text" value="<?php echo ($data["teafaction"]); ?>"/>
