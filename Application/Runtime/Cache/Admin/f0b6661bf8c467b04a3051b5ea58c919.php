...
<table width="1500" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr>
    <td colspan="3" bgcolor="#FFFFFF" class="title" align="center">学生信息</td>
  </tr>
  <tr class="title">
    <td bgcolor="#FFFFFF" width="100">管理员ID</td>
    <td bgcolor="#FFFFFF" width="200">管理员姓名</td>
    <td bgcolor="#FFFFFF" width="100">管理员密码</td>
    <td bgcolor="#FFFFFF" width="100">操作</td>

  </tr>
  <?php if(is_array($admininfo)): foreach($admininfo as $key=>$admin): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100"><?php echo ($admin["id"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($admin["aname"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($admin["apwd"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><a href="/lsacms/admin.php/Main/deladmin?id=<?php echo ($admin["id"]); ?>">删除</a></td>
