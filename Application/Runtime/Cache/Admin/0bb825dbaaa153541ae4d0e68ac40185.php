...
<table width="1500" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr class="title">
    ...
    <td bgcolor="#FFFFFF" width="100">学生密码</td>

  </tr>
  <?php if(is_array($stuuserinfo)): foreach($stuuserinfo as $key=>$stu): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stu["stuid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($stu["stuname"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stu["stupwd"]); ?></td>
