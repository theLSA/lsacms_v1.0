...
<form method="post" action="/lsacms/admin.php/Main/udstuinfo">

<input name="stuid" type="hidden" value="<?php echo ($data["stuid"]); ?>"/>
弟子姓名：<input name="stuname" type="text" value="<?php echo ($data["stuname"]); ?>"/>
弟子性别：<input name="stusex" type="text" value="<?php echo ($data["stusex"]); ?>"/>
弟子年龄：<input name="stuage" type="text" value="<?php echo ($data["stuage"]); ?>"/>
弟子帮派：<input name="stufaction" type="text" value="<?php echo ($data["stufaction"]); ?>"/>
