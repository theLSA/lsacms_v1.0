...
<div class=" admin-content">
	...
	<div class="daohang">
              ...
              <font color="white">个人主页->学生信息查询</font>
...
<table width="1000" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr>
    <td colspan="7" bgcolor="#FFFFFF" class="title" align="center">学生信息</td>
  </tr>
  <tr class="title">
    <td bgcolor="#FFFFFF" width="100">学生ID</td>
    <td bgcolor="#FFFFFF" width="200">学生姓名</td>
    <td bgcolor="#FFFFFF" width="100">学生性别</td>
    <td bgcolor="#FFFFFF" width="100">学生年龄</td>
    <td bgcolor="#FFFFFF" width="150">学生帮派</td>
    <td bgcolor="#FFFFFF" width="200">学生总修炼课程数</td>
    <td bgcolor="#FFFFFF" width="200">操作</td>
  </tr>
  <?php if(is_array($result)): foreach($result as $key=>$stu): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stu["stuid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($stu["stuname"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stu["stusex"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($stu["stuage"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($stu["stufaction"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><?php echo ($stu["stulesnum"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><a href="/lsacms/admin.php/Main/udstuinfomb?stuid=<?php echo ($stu["stuid"]); ?>&stuname=<?php echo ($stu["stuname"]); ?>&stusex=<?php echo ($stu["stusex"]); ?>&stuage=<?php echo ($stu["stuage"]); ?>&stufaction=<?php echo ($stu["stufaction"]); ?>">修改</a>/<a href="/lsacms/admin.php/Main/delstu?stuid=<?php echo ($stu["stuid"]); ?>">删除该学生</a></td>
