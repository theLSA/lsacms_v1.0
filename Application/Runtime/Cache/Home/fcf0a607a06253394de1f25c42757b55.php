...
<table width="600" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  <tr>
    <td colspan="6" bgcolor="#FFFFFF" class="title" align="center">当前登录用户：<?php echo (session('teacher')); ?></td>
  </tr>
  <tr>
  ...
  <tr class="title">
    ...
    <td bgcolor="#FFFFFF" width="100">开设课程数</td>
  </tr>
  <?php if(is_array($list)): foreach($list as $key=>$tea): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100">&nbsp;<?php echo ($tea["teaid"]); ?></td>
    <td bgcolor="#FFFFFF" width="120">&nbsp;<?php echo ($tea["teaname"]); ?></td>
    <td bgcolor="#FFFFFF" width="50">&nbsp;<?php echo ($tea["teasex"]); ?></td>
    <td bgcolor="#FFFFFF" width="50"><?php echo ($tea["teaage"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($tea["teafaction"]); ?></td>
    <td bgcolor="#FFFFFF" width="100"><?php echo ($tea["tealesnum"]); ?></td>
