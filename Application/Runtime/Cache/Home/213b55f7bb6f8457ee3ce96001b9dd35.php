...
<div class=" admin-content">
	...
	<div class="daohang">
              ...
              <font color="white">个人主页->个人开设课程->新增课程</font>
...
<form action="/lsacms/index.php/Home/Teamain/teaaddlesson" method="post">

	<input name="teaid" type="hidden" value=<?php echo (session('teacher')); ?>>
        开设课程名：<input name="lesname" type="text"></br>
        开设课程归属：<input name="lesfaction" type="text"></br>

        <input name="teaaddles" type="submit" value="add">
