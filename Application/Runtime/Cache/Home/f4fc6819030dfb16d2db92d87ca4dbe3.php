...
<div class=" admin-content">
	...
	<div class="daohang">
              ...
              <font color="white">个人主页->个人开设课程->详情->录入分数</font>
...
<div class="admin">
	...
	<?php if(is_array($stulesresult)): $i = 0; $__LIST__ = $stulesresult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$slr): $mod = ($i % 2 );++$i;?><form action="/lsacms/index.php/Home/Teamain/udscore" method="post">
			<input name="stuid" type="hidden" value=<?php echo ($slr["stuid"]); ?>>
			<input name="lesid" type="hidden" value=<?php echo ($slr["lesid"]); ?>>
		弟子姓名：<input name="stuname" type="text" readonly="ture" value=<?php echo ($slr["stuname"]); ?>></br>
		修炼课程：<input name="stules" type="text" readonly="ture" value=<?php echo ($slr["stules"]); ?>></br>
		当前分数：<input name="olderscore" type="text" readonly="ture" value=<?php echo ($slr["stuscore"]); ?>></br>
		----------
		录入新分数：<input name="newscore" type="text"></br>
