...
<table width="800" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr>
    <td colspan="6" bgcolor="#FFFFFF" class="title" align="center">个人课程</td>
  </tr>
  <tr class="title">
  ...
  <?php if(is_array($myleslist)): foreach($myleslist as $key=>$myles): ?><tr class="content">
    ...
    <td bgcolor="#FFFFFF" width="100"><a href="/lsacms/index.php/Home/Stumain/forgetles?stuid=<?php echo (session('student')); ?>&lesid=<?php echo ($myles["lesid"]); ?>">遗忘</td>
