...
<table width="600" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <tr>
    <td colspan="6" bgcolor="#FFFFFF" class="title" align="center">个人已选课程</td>
  </tr>
  <tr class="title">
    <td bgcolor="#FFFFFF" width="100">课程ID</td>
    <td bgcolor="#FFFFFF" width="200">课程名</td>
    <td bgcolor="#FFFFFF" width="150">师傅</td>
    <td bgcolor="#FFFFFF" width="150">课程归属</td>
  </tr>
  <?php if(is_array($myleslist)): foreach($myleslist as $key=>$myles): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100">&nbsp;<?php echo ($myles["lesid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200">&nbsp;<?php echo ($myles["stules"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($myles["stulestea"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($myles["stulesfaction"]); ?></td>
  </tr><?php endforeach; endif; ?>
 <tr>
    <td colspan="6" bgcolor="#FFFFFF">&nbsp;<?php echo ($page); ?></td>
    </tr>
</table>
...
<table width="600" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  <tr>
    <td colspan="5" bgcolor="#FFFFFF" class="title" align="center">当前登录用户：<?php echo (session('student')); ?></td>
  </tr>
  <tr>
    <td colspan="5" bgcolor="#FFFFFF" class="title" align="center">个人可选课程</td>
  </tr>
  <tr class="title">
    <td bgcolor="#FFFFFF" width="100">课程ID</td>
    <td bgcolor="#FFFFFF" width="200">课程名</td>
  ...
  <?php if(is_array($canchooselist)): foreach($canchooselist as $key=>$canchooseles): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100">&nbsp;<?php echo ($canchooseles["lesid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200">&nbsp;<?php echo ($canchooseles["teales"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($canchooseles["teaname"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><?php echo ($canchooseles["lesfaction"]); ?></td>
    <td bgcolor="#FFFFFF" width="150"><a href=/lsacms/index.php/Home/Stumain/addlesson?lesid=<?php echo ($canchooseles["lesid"]); ?>&stuid=<?php echo (session('student')); ?>&lesname=<?php echo ($canchooseles["teales"]); ?>&lestea=<?php echo ($canchooseles["teaname"]); ?>&lesfaction=<?php echo ($canchooseles["lesfaction"]); ?>>修炼</a></td>
  </tr><?php endforeach; endif; ?>
</table>
