...
<table width="800" border="1" cellpadding="1" cellspacing="1" bgcolor="#99CC33" bordercolor="#FFFFFF">
  ...
  <?php if(is_array($tealessonlist)): foreach($tealessonlist as $key=>$tealeslist): ?><tr class="content">
    <td bgcolor="#FFFFFF" width="100">&nbsp;<?php echo ($tealeslist["lesid"]); ?></td>
    <td bgcolor="#FFFFFF" width="200">&nbsp;<?php echo ($tealeslist["teales"]); ?></td>
    <td bgcolor="#FFFFFF" width="200">&nbsp;<?php echo ($tealeslist["lesfaction"]); ?></td>
    <td bgcolor="#FFFFFF" width="100">&nbsp;<?php echo ($tealeslist["tealesstunum"]); ?></td>
    <td bgcolor="#FFFFFF" width="200"><a href="/lsacms/index.php/Home/Teamain/tealeslistmore?lesid=<?php echo ($tealeslist["lesid"]); ?>" target="_blank">详情</a>/<a href="/lsacms/index.php/Home/Teamain/deletelesson?lesid=<?php echo ($tealeslist["lesid"]); ?>&teaid=<?php echo (session('teacher')); ?>">删除该课程</a></td>
 ...
 <tr>
	...
	<div>
		<a href="/lsacms/index.php/Home/Teamain/teaaddlesson">新增课程</a>
	</div>
